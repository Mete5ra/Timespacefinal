...
.content_table td, .content_table th { text-align:center; border-top:1px solid #EFEFEF; border-left:1px solid #EFEFEF; padding:0.3em; background-color: #4d6bb342; }
.content_table th { background-color:#4d6bb342; color:#FFFFFF; line-height: 1.7em; font-weight:normal;}
